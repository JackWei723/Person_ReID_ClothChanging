...
from engine.trainer import do_train_prcc_pix_mse as do_train
from modeling import build_model
from layers import make_loss_with_triplet_entropy_mse
...
def main(cfg):
    ...
    # prepare model
    model = build_model(num_classes, 'global')
    ...
    if cfg.train == 'train':
        ...
        do_train(cfg, model, train_loader, val_loader_c, optimizer, scheduler, loss_func, num_query_c, start_epoch, acc_best, lr_type='step')
    elif cfg.train == 'test':
        # Test
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/prcc_pix_mse'))
