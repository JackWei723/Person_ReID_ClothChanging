...
from engine.trainer import do_train_prcc_base as do_train
...
def main(cfg):
    ...
    # prepare model
    model = build_model(num_classes, 'global')        # num_classes=751
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_per_id', type=int, default=8)
    ...
    parser.add_argument('--train', type=str, default='train', help='train, test')  # change train or test mode
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/prcc_base'))
